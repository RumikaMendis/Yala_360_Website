...
export default function RightSidePanel({ safariCount, blockTraffic = {} }) {
    ...
    return (
        <aside className="right-side-panel">
                ...
                {!collapsed.congestion && (
                    <div className="congestion-content">
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <span className="block-btn-count" style={{
                                                ...
                                                {blockCount || (block.name === 'Block 1' ? 5 : block.name === 'Block 2' ? 3 : block.name === 'Block 3' ? 2 : block.name === 'Block 4' ? 2 : 1)}
                                            </span>
                                        </button>
                                    );
                                })}
                        ...
                        <div className="congestion-legend">
                            <div className="legend-item"><span className="dot" style={{background: '#22c55e'}}></span>Clear &lt; 5</div>
                            <div className="legend-item"><span className="dot" style={{background: '#f59e0b'}}></span>Mod 5-10</div>
                            <div className="legend-item"><span className="dot" style={{background: '#ef4444'}}></span>Heavy &gt; 10</div>
                        </div>
                    </div>
                )}
            </div>
            ...
            <div className="quick-stats">
                ...
                <div className="stat-divider"></div>
                <div className="stat">
                    <span className="stat-value" style={{color: '#ef4444'}}>1 Active</span>
                    <span className="stat-label">ALERTS</span>
                </div>
            </div>

            <ActivityFeed collapsed={collapsed.feed} onToggle={() => toggle('feed')} />
        </aside>
    );
}